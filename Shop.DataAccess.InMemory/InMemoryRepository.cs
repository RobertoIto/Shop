...
{
    // We are going to use generics, in this case T.
    // The generics will help us to save duplicated code for insert,
    ...
    public class InMemoryRepository<T> : IRepository<T> where T : BaseEntity
    {
        ...
        {
            // This will get the class name of the original class.
